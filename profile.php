        ...
        <div class="container">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="edit-profile">
                    <form id="edit-profile-form" autocomplete="off" novalidate="novalidate" class="" method="post" action="processEditProfile.php">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="btn btn-outline-secondary btn-rounded p-0">
                                            <label class="choose-profile-picture-label form-label mb-0 w-100 h-100 p-2"
                                                for="profile-picture-picker">Upload</label>
                                            <input type="file" name="profile-picture-picker" accept="image/*" class="form-control d-none"
                                                id="profile-picture-picker" autocomplete="off" />
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="edit-profile-display-name"
                                        placeholder="Username" value="<?php echo $_SESSION['username'] ?>">
                                    <div id="errors-container_custom-display-name"></div>
                                </div>
                                <div class="mb-3">
                                    <label for="bio" class="form-label">Bio</label>
                                    <textarea class="bio-text form-control" id="bio"
                                        rows="3">Hi I'm <?php echo $_SESSION['full_name']?>!</textarea>
