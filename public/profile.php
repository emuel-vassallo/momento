        ...
        <div class="container">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="edit-profile">
                    <form id="edit-profile-form" autocomplete="off" novalidate="novalidate" method="post" action="../core/processEditProfile.php">
                        <div class="card edit-profile-card">
                            <div class="card-header fw-bold d-flex align-items-center">
                              <div class="row d-flex align-items-center w-100">
                                <a class="col btn btn-link text-start text-nowrap p-0 ps-3" href="register.php" role="button">Back</a>
                            ...
                            <div class="card-body">
                              ...
                              <div class="mb-3">
                                  ...
                                  <textarea class="bio-text form-control" id="bio" rows="3">Hi I'm <?php echo explode(' ', $_SESSION['full_name'])[0]; ?>!</textarea>
