      ...
      results.forEach((result) => {
        html += `
          <li class="search-result-item w-100">
              ...
              <img class='search-result-profile-picture flex-shrink-0' src='/Emuel_Vassallo_4.2D/instagram-clone/${result.profile_picture_path}' alt='${result.display_name}'s profile picture'>
