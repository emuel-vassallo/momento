  ...
  .then((data) => {
    ...
    const displayResults = (results) => {
      ...
      results.forEach((result) => {
        html += `
          <li class="search-result-item w-100 rounded">
                <a href="http://localhost/Emuel_Vassallo_4.2D/instagram-clone/public/user_profile.php?user_id=${result.id}"
                    class="dropdown-item text-decoration-none w-100 d-flex gap-2 p-2 align-items-center justify-content-start rounded">
