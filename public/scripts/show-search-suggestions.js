      ...
      results.forEach((result) => {
        html += `
          <li class="search-result-item w-100">
                <a href="http://localhost/instagram-clone/public/user_profile.php?user_id=${result.id}"
                    class="text-decoration-none w-100 d-flex gap-2 p-2 align-items-center justify-content-start">
              <img class='search-result-profile-picture flex-shrink-0' src='/instagram-clone/${result.profile_picture_path}' alt='${result.display_name}'s profile picture'>
